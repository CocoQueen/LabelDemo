package com.example.coco.labeldemo.adapter;
...
import com.example.coco.labeldemo.bean.LinkLabelBean;
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Zeng < 1) {
                        ...
                        Toast.makeText(context, "最多只能选择1个标签", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
